...
class Trajectories:
    def __init__(self, states=None, rewards=None, returns=None, not_dones=None,
                 ...
                 unrolled=False, values=None, costs = None, advantages_cost = None, values_cost = None, returns_cost = None, next_states = None):
        ...
        self.advantages_cost = advantages_cost
        self.values_cost = values_cost
        self.returns_cost = returns_cost
    ...
    def tensor_op(self, lam, should_wrap=True):
        ...
        tt = op(self.states, self.rewards, self.costs, self.returns, self.returns_cost, self.not_dones, self.next_states)
        tt2 = op(self.actions, self.action_log_probs, self.advantages, self.advantages_cost)
        values, values_cost, = op(self.values, self.values_cost)

        ts = Trajectories(states=tt[0], rewards=tt[1], costs=tt[2], returns=tt[3],
                          returns_cost=tt[4], not_dones=tt[5], next_states = tt[6],
                          actions=tt2[0], action_log_probs=tt2[1], advantages=tt2[2], advantages_cost=tt2[3],
                          values=values, values_cost=values_cost, unrolled=True)
