...
def train():
    ...
    env_name = "QuadrotorSafeMoving-v0"
    ...
    action_std_decay_freq = int(2.5e25)  # action_std decay frequency (in num timesteps)
    #####################################################
    ...
    directory = "PPO_Safe" #"PPO_preTrained"
    ...
    ppo_agent.load('outputs/quad2d_moving_obs_checkpoint_11.pth') # load pre-trained controller
    ...
    time_step = 0
    i_episode = 0
    reachability_start = 0
    use_reachability = False # whether train with bound
    prev_t = 0

    # training loop
    while time_step <= max_training_timesteps:

        if time_step > reachability_start and use_reachability:
            ppo_agent.use_reachability_loss = True
        ...
        for t in range(1, max_ep_len+1):
            ...
            if time_step % print_freq == 0:
                ...
                print("Episode : {} \t\t Timestep : {} \t\t Average Reward : {} \t\t Ep Len: {}".format(i_episode, time_step, print_avg_reward, prev_t))
